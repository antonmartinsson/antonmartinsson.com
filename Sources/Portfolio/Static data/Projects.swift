...
struct Projects {
    ...
    static let platNiklas = ProjectInfo(
        title: "Plåtniklas",
    ...
    static let martinssonPhotography = ProjectInfo(
        title: "Martinsson Photography",
    ...
    static let gaugeKit = ProjectInfo(
        title: "GaugeKit",
    ...
    static let cryptoverview = ProjectInfo(
        title: "Cryptoverview",
